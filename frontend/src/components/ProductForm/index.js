...
import { Container, FormWrapper, FormContent, Form, FormH1, FormInput, FormLabel, FormButton } from './ProductFormElements'
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (res === "Failure"){
                ...
                const result = await axios.post("http://localhost:3000/api/products", postData, { headers })
                ...
                <FormWrapper>
                    <FormContent>
                        ...
                        <Form onSubmit={handleSubmit}>
                            ...
                            <FormInput type='text' name="category" ref={categoryRef}></FormInput>
                            <FormLabel htmlFor="price">Price</FormLabel>
                            <FormInput type='number' name="price" ref={priceRef}></FormInput>
                            <FormLabel htmlFor="provider">Provider</FormLabel>
                            <FormInput type='text' name="provider" ref={providerRef}></FormInput>
                            <FormButton type="submit" disabled={loading}>Add product</FormButton>
                        </Form>
                    </FormContent>
                </FormWrapper>
            </Container>
